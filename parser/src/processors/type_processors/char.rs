...
pub fn collect_char(
    ...
    if let types::Types::Char(ref mut data) = itered_data.data.value {
        ...
        if letter_char == "'" && last_char != "\\" {
            if data.value == '\0' {
                errors.push(error::Error {
                    debug_message: "88ade2c04da9f28d9589f7d5537a1669".to_string(),
            ...
            if data.value != '\0' {
                errors.push(error::Error {
                    debug_message: "6e48f995c41c442e9917cfff307bb397".to_string(),
        ...
        } else if types::arithmetic_type::ArithmeticOperators::is_arithmetic_opearator(letter_char)
        {
            ...
            errors.push(error::Error {
                debug_message: "59e447366e1e3aa264eb6d5d09d58378".to_string(),
