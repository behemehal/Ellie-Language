...
pub fn collect_char(
    ...
    if let types::Types::Char(ref mut data) = itered_data.data.value {
        ...
        if letter_char == "'" && last_char != "\\" {
            if data.value == '\0' {
                errors.push(error::Error {
                    debug_message: "80da14a805dea0178f53fd274731dcdb".to_string(),
            ...
            if data.value != '\0' {
                errors.push(error::Error {
                    debug_message: "3f0c09e9276f57db030ee18eaf4a824f".to_string(),
        ...
        } else if types::arithmetic_type::ArithmeticOperators::is_arithmetic_opearator(letter_char)
        {
            ...
            errors.push(error::Error {
                debug_message: "81b97a90e68457f8a84d97e7eb6554db".to_string(),
