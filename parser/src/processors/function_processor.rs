        ...
        if !functiondata.initialized {
            ...
            if last_entry == 0 && letter_char == ")" {
                ...
                if current_reliability.reliable {
                    ...
                    {
                        errors.push(error::Error {
                            debug_message: "./parser/src/processors/function_processor.rs:140"
                                .to_string(),
                            title: error::errorList::error_s1.title.clone(),
                            code: error::errorList::error_s1.code,
                            message: error::errorList::error_s1.message.clone(),
                    ...
                    errors.push(error::Error {
                        debug_message: "./parser/src/processors/function_processor.rs:185"
                            .to_string(),
                        title: error::errorList::error_s1.title.clone(),
                        code: error::errorList::error_s1.code,
                        message: error::errorList::error_s1.message.clone(),
                ...
                if letter_char == ":" {
                    ...
                    errors.push(error::Error {
                        debug_message: "./parser/src/processors/function_processor.rs:207"
                            .to_string(),
                        title: error::errorList::error_s1.title.clone(),
                        code: error::errorList::error_s1.code,
                        message: error::errorList::error_s1.message.clone(),
                ...
                if current_reliability.reliable {
                    ...
                    {
                        errors.push(error::Error {
                            debug_message: "./parser/src/processors/function_processor.rs:232"
                                .to_string(),
                            title: error::errorList::error_s1.title.clone(),
                            code: error::errorList::error_s1.code,
                            message: error::errorList::error_s1.message.clone(),
                    ...
                    if parameter_names.len() != parameter_names_deduped.len() {
                        errors.push(error::Error {
                            debug_message: "./parser/src/processors/function_processor.rs:276"
                                .to_string(),
                    ...
                    if parameter_names.len() != parameter_names_deduped.len() {
                        errors.push(error::Error {
                            debug_message: "./parser/src/processors/function_processor.rs:313"
                                .to_string(),
                            title: error::errorList::error_s10.title.clone(),
                            code: error::errorList::error_s10.code,
                            message: error::errorList::error_s10.message.clone(),
                    ...
                    {
                        errors.push(error::Error {
                            debug_message: "./parser/src/processors/function_processor.rs:338"
                                .to_string(),
                            title: error::errorList::error_s1.title.clone(),
                            code: error::errorList::error_s1.code,
                            message: error::errorList::error_s1.message.clone(),
