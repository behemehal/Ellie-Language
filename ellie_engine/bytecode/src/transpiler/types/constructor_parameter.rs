...
use ellie_core::definite::items::constructor_parameter::ConstructorParameter;

impl TypeTranspiler for ConstructorParameter {
    fn transpile(&self, options: &mut super::TypeTranspilerOptions) {
        ...
        {
            Some(e) => e,
            None => panic!("Constructor Parameter not found: {}", self.name),
        };
