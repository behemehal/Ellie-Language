    ...
    StringType {
        ...
        comma_start_pos: defs::Cursor {
            range_start: defs::CursorPosition(
                target.comma_start_pos.range_start.0,
                target.comma_start_pos.range_start.1,
            ),
            range_end: defs::CursorPosition(
                target.comma_start_pos.range_end.0,
                target.comma_start_pos.range_end.1,
            ),
        },
        comma_end_pos: defs::Cursor {
            range_start: defs::CursorPosition(
                target.comma_end_pos.range_start.0,
                target.comma_end_pos.range_start.1,
            ),
            range_end: defs::CursorPosition(
                target.comma_end_pos.range_end.0,
                target.comma_end_pos.range_end.1,
            ),
        },
