...
mod definer_tests {
    ...
    fn vector_collective_with_no_error() {
        ...
        assert!(!processor.has_error() && result_hash.finish() == 9256950456458196198);
    }
    ...
    fn nullable_collective_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 1456385834464223876);
    }
    ...
    fn future_collective_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 285075723699432689);
    }
    ...
    fn vector_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 1717801901622985198);
    }
    ...
    fn nullable_vector_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 2095084249452940953);
    }
    ...
    fn future_vector_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 10061816298405055815);
    }
    ...
    fn cloak_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 8269887764424291153);
    }
    ...
    fn nullable_cloak_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 13448889993066499606);
    }
    ...
    fn future_cloak_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 14203049144237276059);
    }
    ...
    fn generic_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 12618347469620875205);
    }
    ...
    fn nullable_generic_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 11751167107972902825);
    }
    ...
    fn future_generic_collected_with_no_error() {
        ...
        let mut result_hash = DefaultHasher::new();
        format!("{:?}", processor.definer_type).hash(&mut result_hash);
        assert!(!processor.has_error() && result_hash.finish() == 12752362452955238480);
    }
}
