use ellie_engine::{
    ellie_core::defs::{
        Cursor, CursorPosition, DebugHeader, DebugHeaderType, DebugInfo, ModuleMap,
    },
    ellie_vm::{program::Program, utils::ProgramReader, utils::Reader},
};
use std::io::Read;
...
pub fn read_program<T: Reader>(program_reader: &mut T) -> Result<Program, u8> {
