...
var version = cargoconf
  .split(whichLineEnding(cargoconf))
...
var changeHeaders =
  dbgversion.split(".")[0] != version.split(".")[0] ||
...
if (!changeHeaders) {
  ...
  scanDirectory(fs.readdirSync("./", { withFileTypes: true }), "./").then(
    (files) => {
